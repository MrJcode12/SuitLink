    ...
    try {
      ...
      if (
        ...
        try {
          ...
          // If resend fails, still redirect but show the original error
          navigate("/verify-email", {
            state: {
              email,
              fromLogin: true,
        ...
        <div className="relative z-10 max-w-md">
          <div className="bg-white/10 backdrop-blur-md rounded-2xl p-8 shadow-2xl border border-white/20">
            ...
            <p className="text-white/80 mb-6 leading-relaxed">
              Track every application in real-time. Connect with employers
              through skill-based matching and experience transparent hiring
